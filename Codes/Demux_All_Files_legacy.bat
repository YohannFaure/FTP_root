...
for %%i in (*.dat) do (
	start /b /wait "" python C:\FTP_root\Codes\host_demux.py --src=C:\FTP_root\DATA\acq2106_377\%%i --egu=1 --save=npy --savelocation=C:\FTP_root\DATA\acq2106_377 --filename=%%i acq2106_377
)
